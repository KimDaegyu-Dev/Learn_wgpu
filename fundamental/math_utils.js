// math_utils.js - 3D 수학 유틸리티 및 큐브 데이터 생성

// 간단한 mat4 구현 (gl-matrix 호환)
export const mat4 = {
  create: () => new Float32Array(16),
  identity: (out = mat4.create()) => {
